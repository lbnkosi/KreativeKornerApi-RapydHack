package com.explr.explravenue.rapyd.collect.product.controller
...
import com.explr.explravenue.rapyd.collect.product.create_service_product.request.CreateServiceProductRequest
import com.explr.explravenue.rapyd.collect.product.create_service_product.response.CreateServiceProductResponse
...
@RestController
@RequestMapping("/rapyd/api/products")
object ProductController {

    private const val PLAN_PATH = "/v1/plans"

    @PostMapping(value = ["/createproduct"])
    fun createProduct(@RequestBody request: CreateServiceProductRequest): CreateServiceProductResponse {
        ...
        val type: Type = object : TypeToken<CreateServiceProductResponse>() {}.type
